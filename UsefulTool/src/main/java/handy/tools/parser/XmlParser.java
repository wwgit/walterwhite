...
public class XmlParser implements Parser {
	...
	private static final String REF_LOCAL_BEAN = "local";
	private static final String REF_BEAN_BEAN = "bean";
	
	private static final int REF_BEAN_NOT_INIT = "REFERENCE_BEAN_NOT_INIT".hashCode();
	private static final int REF_LOCAL_NOT_INIT = "REFERENCE_LOCAL_NOT_INIT".hashCode();
